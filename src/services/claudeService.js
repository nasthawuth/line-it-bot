...
การ Setup Email:
- Incoming Mail Server: mail.scgroupthai.com
- Outgoing Mail Server: mail.scgroupthai.com
- Microsoft Outlook: ใช้ Email และรหัสผ่าน Windows ของบริษัท
- iPhone/iPad: Settings → Mail → Add Account → Microsoft Exchange
...
const askClaude = async (userId, userMessage) => {
    try {
        ...
        return 'ขออภัย ระบบขัดข้องชั่วคราว กรุณาลองใหม่อีกครั้ง หรือติดต่อ IT Support โดยตรงค่ะ';
    }
};
